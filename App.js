...
import macaco from "./img/beijo.png"
import beijo from "./img/macaco.png"
...
function App() {
  return (
    <div className="App">
      ...
      <img src={macaco} title='beijo' height='100px' width='100px' />
      <img src={beijo} title='Macaco' height='100px' width='100px' />
